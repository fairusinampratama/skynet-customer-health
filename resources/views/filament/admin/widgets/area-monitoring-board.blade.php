                ...
                <div x-data="{ 
                    ...
                    @foreach($this->areas as $area)
                        ...
                        <a href="{{ route('filament.admin.resources.areas.edit', $area->id) }}" 
                           class="flex flex-col h-full relative {{ $isWallboard ? 'p-2' : 'p-5' }} bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-600 ring-1 ring-gray-950/5 dark:ring-white/10 rounded-xl shadow-md hover:shadow-lg hover:border-primary-200 dark:hover:border-primary-900 transition-all duration-300 group overflow-hidden">
