...
class SlaStatsOverview extends StatsOverviewWidget
{
    ...
    protected function getStats(): array
    {
        ...
        // Overall SLA: (total checks - down checks) / total checks * 100
        ...
        // Average recovery time (simplified: average time between status changes)
        // Using a simpler approach: avg time between down and next non-down for each customer
        ...
        return [
            ...
            Stat::make('Rata-rata Recovery', $avgRecovery)
                ->description('Waktu downtime → uptime')
